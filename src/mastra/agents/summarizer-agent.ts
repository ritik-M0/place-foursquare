...
export const summarizerAgent = new Agent({
  ...
  instructions: `
    ...
    **CRITICAL INSTRUCTIONS:**
    ...
    5.  **Handle Empty/Error Data:** If the data is empty or indicates an error, provide a polite message indicating that the information could not be retrieved or is unavailable.
